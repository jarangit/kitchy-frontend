export const thMessages = {
  ...
  "settings.modifiers.title": "จัดการตัวเลือกเสริม",
  "settings.modifiers.addGroup": "เพิ่มกลุ่ม",
  "settings.modifiers.emptyTitle": "ยังไม่มีกลุ่มตัวเลือก",
  ...
  "settings.modifiers.col.minMax": "ต่ำสุด–สูงสุด",
  "settings.modifiers.col.status": "สถานะ",
  "settings.modifiers.col.actions": "จัดการ",
  "settings.modifiers.optionCount": "{count} ตัวเลือก",
  "settings.modifiers.typeSingle": "เลือกได้อย่างเดียว (radio)",
  "settings.modifiers.typeMultiple": "เลือกได้หลายอย่าง (checkbox)",
  "settings.modifiers.typeSingleShort": "เดี่ยว",
  ...
  "settings.modifiers.minSelect": "เลือกขั้นต่ำ",
  "settings.modifiers.minSelectMin": "ขั้นต่ำต้องเป็น 0 ขึ้นไป",
  "settings.modifiers.maxSelect": "เลือกสูงสุด",
  "settings.modifiers.maxSelectMin": "สูงสุดต้องเป็น 0 ขึ้นไป",
  "settings.modifiers.minExceedsMax": "ขั้นต่ำต้องไม่เกินขั้นสูงสุด",
  "settings.modifiers.singleMaxExceeded": "แบบเดี่ยวเลือกได้สูงสุด 1 อย่าง",
  "settings.modifiers.singleHint":
    "แบบเดี่ยวแสดงเป็น radio ใน POS และเลือกได้สูงสุด 1 อย่าง",
  "settings.modifiers.multipleHint":
    "แบบหลายอย่างแสดงเป็น checkbox ใน POS ตามช่วงต่ำสุด–สูงสุด",
  ...
  "settings.modifiers.inactiveGroupHint":
    "กลุ่มนี้ปิดใช้อยู่: ถูกซ่อนใน POS และผูกกับสินค้าใหม่ไม่ได้",
  ...
  "settings.modifiers.alreadyAssigned": "ผูกกลุ่มนี้แล้ว",
  "settings.modifiers.removeFailed": "ถอดกลุ่มไม่สำเร็จ",
  "settings.modifiers.detailTitle": "กลุ่มตัวเลือก",
  "settings.modifiers.backToModifiers": "กลับไปหน้าตัวเลือก",
  "settings.modifiers.createAndContinue": "สร้างกลุ่มและทำต่อ",
  ...
  "settings.modifiers.optionsHealthWarning":
    "ต้องเลือกอย่างน้อย {min} อย่าง แต่ใช้ได้ {active} อย่าง เพิ่มหรือเปิดตัวเลือกกลับมา ไม่เช่นนั้นสินค้าที่ผูกจะสั่งไม่ได้",
  "settings.modifiers.assignmentGroupDescription":
    "เลือกสินค้าที่ใช้กลุ่มนี้ตามลำดับแสดง",
  "settings.modifiers.attachProducts": "ผูกกับสินค้า",
  "settings.modifiers.loadingAttached": "กำลังโหลดสินค้าที่ผูก...",
  "settings.modifiers.noAttachedProducts": "ยังไม่ผูกกับสินค้าไหน",
  "settings.modifiers.noAttachedProductsDescription":
    "ติ๊กสินค้าด้านล่างเพื่อให้มีกลุ่มนี้ใน POS",
