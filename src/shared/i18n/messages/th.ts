export const thMessages = {
  ...
  "settings.menu.categories.description": "จัดการหมวดหมู่สินค้า",
  ...
  "settings.categories.description": "หมวดหมู่ถูกจัดการผ่านสเตชัน โดยแต่ละสเตชันทำหน้าที่เป็นหมวดหมู่สำหรับจัดกลุ่มสินค้า",
