...
export const enMessages = {
  ...
  "settings.cp.kitchen.modifiers": "Go to modifiers",

  "settings.modifiers.title": "Modifier Management",
  "settings.modifiers.addGroup": "New group",
  "settings.modifiers.emptyTitle": "No modifier groups yet",
  "settings.modifiers.emptyDescription":
    "Create a group such as Size or Toppings, add its options, then attach it to products.",
  "settings.modifiers.searchPlaceholder": "Search groups",
  "settings.modifiers.filterStatus": "Status",
  "settings.modifiers.filterStatusAll": "All",
  "settings.modifiers.filterStatusActive": "Active",
  "settings.modifiers.filterStatusInactive": "Inactive",
  "settings.modifiers.showingCount": "{shown} of {total} groups",
  "settings.modifiers.clearFilters": "Clear filters",
  "settings.modifiers.noResults": "No groups match",
  "settings.modifiers.noResultsDescription":
    "Try a different search or status filter.",

  "settings.modifiers.col.name": "Group",
  "settings.modifiers.col.type": "Type",
  "settings.modifiers.col.minMax": "Min–Max",
  "settings.modifiers.col.status": "Status",
  "settings.modifiers.col.actions": "Actions",
  "settings.modifiers.optionCount": "{count} options",
  "settings.modifiers.typeSingle": "Single choice (radio)",
  "settings.modifiers.typeMultiple": "Multiple choice (checkbox)",
  "settings.modifiers.typeSingleShort": "Single",
  ...
  "settings.modifiers.groupName": "Group name",
  "settings.modifiers.groupNamePlaceholder": "e.g. Size, Sweetness",
  "settings.modifiers.groupNameRequired": "Group name is required",
  "settings.modifiers.groupNameMin": "Name must be at least 2 characters",
  "settings.modifiers.selectionType": "Selection type",
  "settings.modifiers.minSelect": "Minimum selections",
  "settings.modifiers.minSelectMin": "Minimum must be 0 or more",
  "settings.modifiers.maxSelect": "Maximum selections",
  "settings.modifiers.maxSelectMin": "Maximum must be 0 or more",
  "settings.modifiers.minExceedsMax": "Minimum must not exceed maximum",
  "settings.modifiers.singleMaxExceeded":
    "Single choice allows at most 1 selection",
  "settings.modifiers.singleHint":
    "Single choice renders as radio buttons in POS and allows at most 1 selection.",
  "settings.modifiers.multipleHint":
    "Multiple choice renders as checkboxes in POS within the min–max range.",
  "settings.modifiers.create": "Create",
  "settings.modifiers.creating": "Creating...",
  "settings.modifiers.save": "Save",
  ...
  "settings.modifiers.inactiveGroupHint":
    "This group is inactive: it is hidden in POS and cannot be attached to new products.",
  "settings.modifiers.optionName": "Option name",
  "settings.modifiers.optionNamePlaceholder": "e.g. Large, Extra cheese",
  "settings.modifiers.priceAdjustment": "Price adjustment",
  "settings.modifiers.sortOrder": "Order",
  "settings.modifiers.sortOrderShort": "Order {order}",
  "settings.modifiers.noPriceChange": "No price change",
  ...
  "settings.modifiers.alreadyAssigned": "This group is already attached",
  ...
  "settings.modifiers.loadingGroup": "Loading group...",
  "settings.modifiers.groupNotFound": "Group not found",
  "settings.modifiers.groupNotFoundDescription":
    "It may have been deleted. Go back and pick another group.",
  "settings.modifiers.optionsTitle": "Options",
  "settings.modifiers.optionsLockedHint":
    "Create the group first — options unlock on the next step.",
  "settings.modifiers.optionsHealthWarning":
    "Requires at least {min} selections but only {active} options are available. Add or re-enable options, or the attached products cannot be ordered.",
  "settings.modifiers.assignmentGroupDescription":
    "Choose which products offer this group, in display order.",
  "settings.modifiers.attachProducts": "Attach to products",
  "settings.modifiers.loadingAttached": "Loading attached products...",
  "settings.modifiers.noAttachedProducts": "Not attached to any product",
  "settings.modifiers.noAttachedProductsDescription":
    "Tick products below to offer this group in POS.",
  ...
  "settings.cp.safety.settingsPin": "Settings PIN",
  "settings.cp.safety.settingsPin.hint":
    "Require a 4-6 digit PIN before updating store settings",
  "settings.cp.safety.settingsPin.notSet": "No PIN set",
  "settings.cp.safety.settingsPin.set": "PIN set ••••",
  "settings.cp.safety.settingsPin.setPin": "Set PIN",
  "settings.cp.safety.settingsPin.changePin": "Change PIN",
  "settings.cp.safety.settingsPin.removePin": "Remove PIN",
  "settings.pin.verify.title": "Enter PIN",
  "settings.pin.verify.description": "Enter the 4-6 digit PIN to open Settings",
  "settings.pin.verify.hint": "Enter 4-6 digits then confirm",
  "settings.pin.create.title": "Set new PIN",
  "settings.pin.create.description": "Create a 4-6 digit PIN for Settings",
  "settings.pin.confirm.title": "Confirm PIN",
  "settings.pin.confirm.description": "Re-enter the PIN to confirm",
  "settings.pin.confirm.hint": "Must match the first entry",
  "settings.pin.error.incorrect": "Incorrect PIN. Try again.",
  "settings.pin.error.mismatch": "PINs do not match. Try again.",
  ...
  "settings.pin.success.removed": "PIN removed",
  ...
  "pos.modifier.title": "Customize {name}",
  "pos.modifier.required": "Required",
  "pos.modifier.optional": "Optional",
  "pos.modifier.chooseOne": "Choose 1",
  "pos.modifier.chooseUpToOne": "Up to 1",
  "pos.modifier.chooseRange": "Choose {min}–{max}",
  "pos.modifier.chooseAtLeast": "Choose at least {min}",
  "pos.modifier.chooseUpTo": "Choose up to {max}",
  "pos.modifier.errorRequired": "Please select {name}",
  "pos.modifier.errorMin": "Select at least {min} for {name}",
  "pos.modifier.errorMax": "Select at most {max} for {name}",
  "pos.modifier.completeRequired": "Complete the required options to continue",
  "pos.modifier.addToCart": "Add • {total}",
  "pos.modifier.loadFailed": "Could not load options. Please try again.",
  ...
  "dashboard.operations.eyebrow": "Overview",
  "dashboard.operations.title": "Status",
  "dashboard.operations.stage.all": "All orders",
  "dashboard.operations.stage.openOrders": "Open orders",
  "dashboard.operations.stage.kitchen": "In kitchen",
  "dashboard.operations.stage.ready": "Ready to serve",
  "dashboard.operations.helper.all": "All orders placed today",
  ...
  "dashboard.operations.emptyDescription":
    "Items will appear here once orders come in.",
  "dashboard.operations.badge.prepare": "Preparing",
  "dashboard.operations.badge.cooking": "Cooking",
  "dashboard.operations.badge.ready": "Ready",
  "dashboard.operations.itemCount": "{count} items",
  ...
  "serve.hint.tapItem": "Tap an item once served",
  "serve.complete.title": "Fully served",
  "serve.complete.historyHint": "This order will leave this board",
  "serve.complete.openHistory": "Review in Transactions",
  ...
  "transaction.filter.orderTypeLabel": "Order type",
  "transaction.filter.orderType.all": "All types",
  "transaction.filter.orderType.dineIn": "Dine-in",
  "transaction.filter.orderType.togo": "Takeaway",
  "transaction.filter.orderType.delivery": "Delivery",
  "transaction.filter.dateLabel": "Date",
  "transaction.filter.date.all": "All dates",
  "transaction.filter.date.today": "Today",
  "transaction.filter.date.yesterday": "Yesterday",
  "transaction.filter.date.last7Days": "Last 7 days",
