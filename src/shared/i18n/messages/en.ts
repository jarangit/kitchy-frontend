export const enMessages = {
  ...
  "settings.menu.categories.description": "Manage product categories",
  ...
  "settings.categories.description": "Categories are managed through stations. Each station acts as a category for grouping products.",
