...
export const enMessages = {
  ...
  "dashboard.readyForService": "Your store is ready to start taking orders",
  "dashboard.controlSection": "Control the store",
  "dashboard.ordersHint": "Review sales and order history",
  "dashboard.kdsHint": "Monitor kitchen work and item status",
  "dashboard.settingsHint": "Manage menus, stations, and store details",
  ...
  "kds.empty.servedTitle": "No served items yet",
  ...
  "demo.trial.badge": "No sign-up",
  "demo.trial.chooseType": "Demo data resets each time you start a trial session.",
  "demo.trial.chooseTypeHint": "Start in dine-in mode, then switch to takeaway or delivery anytime inside POS.",
  "demo.trial.chooseStorePreset": "Choose a restaurant style",
  "demo.trial.chooseStorePresetHint": "Restaurant style changes the demo menu, categories, store name, and seeded sample data.",
  "demo.trial.selectPrompt": "Choose the restaurant style closest to your business to start the demo.",
  "demo.trial.selectedPrefix": "Selected:",
