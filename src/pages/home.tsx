...
//       orderCount: orders?.filter((i: any) => i.status === "PENDING").length,
...
//       orderCount: orders?.filter((i: any) => i.type === "TOGO" && i.status === "PENDING").length,
...
//       orderCount: orders?.filter((i: any) => i.type === "DINEIN" && i.status === "PENDING").length,
