...
function ReadyOrderCard({
  ...
  return (
    <article className="flex max-h-full min-h-0 w-[360px] shrink-0 self-stretch flex-col overflow-hidden rounded-card bg-surface transition-colors duration-normal">
...
function CompletedOrderCard({
  ...
  return (
    <article className="flex max-h-full min-h-0 w-[360px] shrink-0 self-stretch flex-col items-center justify-center gap-2 overflow-hidden rounded-card bg-success-bg px-4 py-8 text-center text-success">
